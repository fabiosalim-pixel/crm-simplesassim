...
## PASSO 6 — EXTRAIR ENDEREÇO DO SEGURADO

Buscar o endereço do segurado/proponente (NÃO o do corretor, NÃO o local de risco da empresa quando houver segurado pessoa física). Pode aparecer como "Endereço", "Endereço de Correspondência", "Endereço Residencial":
- cep: CEP com hífen (ex: "71915-500")
- logradouro: rua/avenida/quadra SEM o número (ex: "QUADRA 106", "Rua das Flores")
- numero: número do endereço (ex: "803")
- complemento: complemento (ex: "LT 04 BL B AP", "APT 207", "Sala 49")
- bairro: bairro (ex: "NORTE AGUAS CLARAS")
- cidade: cidade (ex: "BRASILIA")
- uf: sigla do estado (ex: "DF")
→ Se algum campo não existir, deixar string vazia ""

## PASSO 7 — EXTRAIR CONDUTOR PRINCIPAL
...
## PASSO 8 — EXTRAIR DADOS DO VEÍCULO
...
## PASSO 9 — EXTRAIR VIGÊNCIA E OPERAÇÃO
